...
# 주요 개발자 소개
## macle (https://github.com/macle86)
...
- 기술 특허개발 (회사 등록): 유사관점을 활용한 규칙기반 유사도 -> (제 10-2564316호) 문서간 유사 영역을 실별하는 전자 장치, 제어 방법 및 컴퓨터 프로그램
- 2012년 부터 자동매매는 회사업무가 끝난 후 개인 적으로 연구